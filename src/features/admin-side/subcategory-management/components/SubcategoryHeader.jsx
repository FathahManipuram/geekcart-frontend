...
const SubcategoryHeader = () => {
  ...
  const {createSubcategory, fetchSubcategories, queryParams,}= useSubcategoryStore()
...
setOpenCreateSubcategoryModal(false)
  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      ...
      >
        <SubcategoryForm onSubmit={handleSubmit} onClose={()=> setOpenCreateSubcategoryModal(false)} schema={createSubcategorySchema}/>
      </Modal>
