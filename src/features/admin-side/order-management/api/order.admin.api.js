...
export const updateOrderStatusApi = async (orderId, payload) =>
  adminApi.patch(`/admin/orders/${orderId}/status`, payload);
export const updateorderItemStatusApi = async (orderId, itemId, payload) =>
  adminApi.patch(`/admin/orders/${orderId}/items/${itemId}/status`, payload);
